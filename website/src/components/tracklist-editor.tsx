...
export function TracklistEditor({
  ...
  const handleCueDropInternal = useCallback(
    (acceptedFiles: File[]) => {
  ...
  return (
    <Card>
      <div className="grid grid-cols-[1fr_auto] justify-between gap-3">
        <CardHeader>
      ...
      <CardContent className="grid grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Provide general information about this mix or set. These map to the disc-level tags in a
              traditional CUE sheet.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col gap-3">
            ...
            <div className="space-y-2">
              ...
              {artworkFile ? (
                <p className="text-muted-foreground text-xs">Selected: {artworkFile.name}</p>
              ) : (
        ...
        <div className="flex max-h-[75vh] flex-col gap-4 overflow-y-scroll">
          <div className="flex flex-row gap-1.5">
            <span className="text-muted-foreground text-lg font-medium">Tracks</span>
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between gap-6">
                      <div className="flex w-full flex-col gap-2">
                        <p className="text-muted-foreground py-1.5">Track {idx + 1}</p>
                        <Input
                          value={track.title}
