    ...
    useImperativeHandle(
      ...
      () => ({
        seekTo: (ms: number) => {
          ...
          const nextSeconds = Math.max(0, Math.min(ms / 1000, durationSeconds));
      ...
      <Card>
        <div className="grid grid-cols-[1fr_auto] justify-between gap-3">
          <CardHeader>
            ...
            <CardDescription>Upload your source file and preview its waveform.</CardDescription>
          </CardHeader>
        ...
        <CardContent className="flex flex-col gap-4">
          <div className="bg-muted/40 relative rounded-md border p-4">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
              <div className="text-muted-foreground flex flex-col gap-2 text-sm">
                <div>
                  Now playing <span className="text-primary font-mono">{formatTime(currentMs)}</span> /{' '}
